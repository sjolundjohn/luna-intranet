      ...
      <aside className="w-64 bg-black/20 border-r border-white/10 flex flex-col">
        ...
        <nav className="flex-1 p-4">
          ...
          <div className="mt-8 pt-4 border-t border-white/10">
            <p className="px-4 text-xs font-semibold text-white/40 uppercase tracking-wider mb-3">Beta</p>
            <Link
              href="/clinical-trial"
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                router.pathname.startsWith('/clinical-trial')
                  ? 'bg-[#68d2df] text-[#041e42]'
                  : 'hover:bg-white/10'
              }`}
            >
              ...
              Clinical Trial
              <span className="ml-auto text-xs bg-[#68d2df]/20 text-[#68d2df] px-2 py-0.5 rounded-full">New</span>
            </Link>
          </div>
        </nav>
