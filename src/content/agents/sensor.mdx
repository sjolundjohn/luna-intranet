...
name: "Sensor"
status: "live"
summary: "Adversarial code reviewer for the Luna AI Workforce. Reviews Pump's plans before code is written and Pump's PRs after. Read-only. Never approves when uncertain."
accessHint: "Slack DM · @Sensor — platform team only"
scope: "1:many"
