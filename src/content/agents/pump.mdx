...
name: "Pump"
status: "live"
summary: "Platform builder. Scaffolds Worker code, wires the router, opens PRs. Never deploys. Never merges. Pumps deliver; humans approve. Used by the platform team via Claude Code today; Slack DM wiring queued."
accessHint: "Platform team via Claude Code · Slack DM coming"
scope: "1:many"
