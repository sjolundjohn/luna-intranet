...
You can [see the architecture](/ai/platform/architecture) for the request flow, or the [privacy page](/ai/platform/privacy) for what's kept private and what isn't.
