...
## icons/
9 custom icons exported as SVG; 24 icons map to **SF Symbols** (use the system symbol, not an asset). See `icons/icons-manifest.json` for names, SF-Symbol mappings, and which screens use each. 12 inline SVG instance(s) didn't match the curated map and need naming.
